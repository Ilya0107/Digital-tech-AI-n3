...
Создаем диаграмму mermaid на Яндекс Вики:
<img width="1349" height="491" alt="image" src="https://github.com/user-attachments/assets/f5ce05a4-ac2d-413a-b33e-b7e27ed196b3" />
Создаем диаграмму plantUML на Яндекс Вики:
<img width="1340" height="540" alt="image" src="https://github.com/user-attachments/assets/9ce01b1f-bb22-4018-ab23-6dbab5354fa3" />
Создаем блок схему Draw.io:
<img width="1288" height="840" alt="image" src="https://github.com/user-attachments/assets/a9bd4fb2-631a-4b06-a007-abe0b0c81ad5" />

Эти три диагрммы копия тех, что мы получали на других сайтах. Яндекс вики позволяет работать со многими диаграммами в одном месте, что делает его наиболее удобным.

**WYSIWYG (произносится «визивиг»).**
Это аббревиатура от английской фразы What You See Is What You Get, что в переводе означает «Что видишь, то и получишь». Это принцип работы программного обеспечения, позволяющий редактировать контент (текст, изображения, макеты) в визуальном редакторе таким образом, чтобы он выглядел в процессе создания практически так же, как и в финальном виде (например, как на веб-странице или при печати), без необходимости писать сложный код вручную.
